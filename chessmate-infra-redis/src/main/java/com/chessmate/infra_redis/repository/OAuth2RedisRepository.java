...
import com.chessmate.infra_redis.prefix.Oauth2RedisPrefix;
...
public class OAuth2RedisRepository {
  ...
  public void saveProviderToken(Long id, OAuthPlatForm provider, String providerToken, int expiration) {
    String key = "";
    switch(provider) {
