package com.chessmate.api.chesscom.oauth.service;
...
public class ChesscomOauthService {
  ...
  public OauthUrlResponse getOauthUrl() {
    ...
    String client_id = chesscomConfig.getClientId();
    String redirect_uri = chesscomConfig.getRedirectUrl();
    ...
    URI frontChannelUrl = URI.create(chesscomConfig.getOauthUrl() + "?" + paramString);
  ...
  public void callback(String code, String state, HttpServletResponse res) {
    ...
    OauthAccessTokenDto dto = chesscomApiService.getOAuthAccessToken(
...
//
//    var refreshToken = jwtService.generateRefreshToken(res, user);
//    var accessToken = jwtService.generateAccessToken(res, user);
//
